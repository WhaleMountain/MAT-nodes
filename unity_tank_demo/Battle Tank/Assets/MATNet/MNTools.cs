...
namespace MATNet
{
    public delegate void LogEventHandler(object message);
    ...
    public static class MNTools
    {
        ...
        public static event LogEventHandler DebugLogEvent;
        public static event LogEventHandler DebugLogErrorEvent;
        ...
        {
            DebugLogErrorEvent(message);
        }

        public static object GetInstance(string className)
        {
            Type type = Type.GetType("MATNet.Plugins."+className);
            if (type == null) { MNTools.DebugLogError("不正なクラス名です"); }
            object obj = Activator.CreateInstance(type);
            if (obj == null) { DebugLogError("インスタンスの作成に失敗"); }
            return obj;
        }
